...
const ArticlesTimeline = ({
  ...
  return (
    <section className="section-shell mt-4 pb-12 pt-6">
      <div className="flex w-full max-w-4xl flex-col space-y-8 rounded-3xl border border-border/60 bg-card p-8 shadow-[0_18px_60px_rgba(0,0,0,0.06)] dark:border-white/8 dark:bg-card dark:shadow-[0_32px_90px_rgba(0,0,0,0.85)]">
